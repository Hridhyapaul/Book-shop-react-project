...
const BookDetails = () => {
    ...
    const { authors, image, url, language, pages, price, publisher, rating, subtitle, title, year, desc } = book;
    console.log(book)
        ...
        <div className='my-container'>
            ...
            <div className='flex flex-col max-w-screen-lg overflow-hidden bg-white border rounded shadow-sm lg:flex-row sm:mx-auto'>
                ...
                <div className=' p-8 bg-white lg:p-16 lg:pl-10 lg:w-1/2'>
                    ...
                    <p className=' text-gray-900'>Language: {language}</p>
                    <p className=' text-gray-900'>Pages: {pages}</p>
                    ...
                    <p className='mb-5 text-gray-900'>Rating: {rating}</p>
                    {
                        fold ? (<>
                            ...
                            <span className='text-blue-500 font-bold cursor-pointer' onClick={() => setFold(!fold)}>Read More</span>
                        </>) :
                            (
                                <>
                                    <p className=' text-gray-500'>{desc}</p>
                                    <span className='text-blue-500 font-bold cursor-pointer' onClick={() => setFold(!fold)}>Read Less </span>
                                </>
                            )
                    }
